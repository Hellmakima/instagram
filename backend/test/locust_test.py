...
class LoginUser(HttpUser):
    ...
    def access_me_html(self):
        if self.access_token:
            ...
            self.client.get("/static/test/me.html", headers=headers, name="/me.html [authenticated]")
        else:
    ...
    def login(self):
        ...
        if response.status_code == 202:
            try:
                ...
                print(f"Login successful. Access Token: {self.access_token[:10]}...") # Print first 10 chars
